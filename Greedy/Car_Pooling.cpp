...
// passengers that must be picked up, and the locations to pick
// them up and drop them off.  The locations are given as the
// number of kilometers due east from your vehicle's initial location.
//
